  ...
  <div v-if="post && user" class="post">
    ...
    <div class="post-content">
      <template v-if="!editing">
        ...
        <a v-if="userCanEdit" @click.prevent="editing = true" href="#" style="margin-left: auto;" class="link-unstyled" title="Make a change"><i class="fa fa-pencil"></i></a>
      </template>
      <div v-else>
        <PostEditor
          :post="post"
...
<script>
    ...
    export default {
      ...
      computed: {
        ...
        userCanEdit () {
          return this.post.userId === this.$store.state.auth.authId
        },
        userPostsCount () {
